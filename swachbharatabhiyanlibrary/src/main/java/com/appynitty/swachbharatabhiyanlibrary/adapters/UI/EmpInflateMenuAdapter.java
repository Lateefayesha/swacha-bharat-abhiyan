...
public class EmpInflateMenuAdapter extends ArrayAdapter<MenuListPojo> {
    ...
    public EmpInflateMenuAdapter(@NonNull Context context, @NonNull List<MenuListPojo> objects) {
